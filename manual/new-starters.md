...
* `git-secrets --add --global --allowed '12345'`: this will add an allowed dummy AWS account number of *12345*. This can be used, for example, when writing example code in a README which uses an AWS account number.
