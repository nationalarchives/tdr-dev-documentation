...
- [tdr-transfer-service](https://github.com/nationalarchives/tdr-transfer-service) - API for supporting non-network drive transfers and other TDR operations
- [da-reference-generator](https://github.com/nationalarchives/da-reference-generator) - Code for generating unique citable references for transferred records
- [da-metadata-schema](https://github.com/nationalarchives/da-metadata-schema) - Json schemas and configuration providing the structure of metadata in TDR

### Auth

- [tdr-auth-server](https://github.com/nationalarchives/tdr-auth-server) - TDR KeyCloak instance
...
- [tdr-common-utils](https://github.com/nationalarchives/tdr-common-utils) - Common libraries and shared code used across TDR
...
- [tdr-file-checks](https://github.com/nationalarchives/tdr-file-checks/) - Task for: checking malware scan results; calculating the server-side checksum of uploaded files; determining the format of uploaded files
...
- [tdr-aggregate-processing](https://github.com/nationalarchives/tdr-aggregate-processing) - Lambda to handle the aggregate processing of a loaded transfer from a client, and integrate the loaded metadata into the TDR transfer workflow.
...
- [tdr-terraform-github](https://github.com/nationalarchives/tdr-terraform-github) - Terraform scripts for configuring GitHub repositories.
