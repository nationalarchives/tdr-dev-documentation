...
Quote from Preservation team:
> "I think utf8-validator is only used with DRI. I'm not aware of it having wider use like CSV Validator. In practice it's only a few lines of code looking for the absence of certain byte ranges."

Based on this research, the same can now be done better through the language's native features.
